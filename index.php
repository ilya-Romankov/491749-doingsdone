...
$tasks= [
    ...
    ["task" => "Выполнить тестовое задание","date" => "10.05.2018","category" => "Работа","done" => "Нет"],
    ...
    ["task" => "Купить корм для кота","date" => "","category" => "Домашние дела","done" => "Нет"],
    ["task" => "Заказать пиццу","date" => "","category" => "Работа","done" => "Нет"]
];
$filtered_tasks=[];
$category_active = 0;
